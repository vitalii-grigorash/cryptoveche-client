...
const ObserverCryptoBlock = () => {
    ...
    return (
            <div className={'observer-crypto-block-wrapper'}>
                    ...
                    <h3 className={'observer-crypto__elem2'}>Получите невероятное наслаждение от всяких там знаете ли транзакций и блоков и почувствуйте себя совсем уж профи, перейдя в систему “Обозреватель блоков системы электронных голосований”!</h3>
