...
const MyVotesBlock = React.memo(({ myVotes, requestHelper, handleCurrentEvents, handleRegistrationUserInEvents }) => {
  ...
  return (
    <div className={'my-votes-block-wrapper'}>
      <h2>Мои голосования</h2>
			{shortEventsData && shortEventsData.map(votesData => <MyVotesBlockForm 
			key={votesData.id} 
			votesData={votesData} 
