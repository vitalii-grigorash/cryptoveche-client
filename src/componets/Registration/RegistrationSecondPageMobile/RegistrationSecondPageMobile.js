...
const RegistrationSecondPageMobile = () => {
    ...
    const completeProcessRegistrationMobilePage = () => {
                ...
                <div className={'container-reg _reg-block-hidden'}>
                    <div className={'reg-block'}>
                        <div className={'reg-block-logotype _modificator-reg-block-logotype-height'}>
                            <img alt={''} className={'auth-image-mobile _modificator-auth-image-mobile-height'} src={bg_image_mobile}/>
                        ...
                        <div className={hideRegForm ? 'reg-block__reg-form active' : 'reg-block__reg-form'}>
                            ...
                            <div className={'reg-form__button'}>
                                ...
                                <button type={'button'} onClick={e => {completeProcessRegistrationMobilePage(e)}}>Зарегистрироваться</button>
                            </div>
                        </div>
                    </div>
                </div>
