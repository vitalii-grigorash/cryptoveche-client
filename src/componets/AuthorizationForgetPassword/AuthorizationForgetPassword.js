...
const AuthorizationForgetPassword = () => {
    ...
    const showModalWindowMobileVersion = () => {
         setModalActive(true)
         setHideBlock(true)
    }
                            ...
                            <div className={'auth__title _modificator-auth__title-padding-left'}>
                                ...
                                <div className={'auth__form'}>
                                    ...
                                    <div className={'auth__button'}>
                                        <button type={'submit'} onClick={() => {showModalWindow()}}>Отправить</button>
                                    </div>
                                    <div className={'auth__button-mobile'}>
                                        <button className={'button-ready-mobile'} type={'submit'} onClick={() => {showModalWindowMobileVersion()}}>Готово</button>
                                    </div>
                                </div>
